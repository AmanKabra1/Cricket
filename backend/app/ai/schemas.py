"""Request/response models for the in-process AI engine.

Mirrors the relevant parts of the platform's live-score schema (the same dict the
scoreboard already builds is fed straight in).
"""
